...
export async function confirmBooking(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function declineBooking(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function startBooking(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function completeBooking(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
